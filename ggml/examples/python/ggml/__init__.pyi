...
class lib:
    ...
    def ggml_cl_mul_mat_get_wsize(
        src0: ffi.CData, src1: ffi.CData, dst: ffi.CData
    ) -> int:
    ...
    def ggml_conv_1d_ph(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, s: int, d: int
    ) -> ffi.CData:
        """
    ...
    def ggml_cross_entropy_loss(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_diag_mask_inf_inplace(
        ctx: ffi.CData, a: ffi.CData, n_past: int
    ) -> ffi.CData:
        """
        in-place, returns view(a)
    ...
    def ggml_graph_compute_with_ctx(
        ctx: ffi.CData, cgraph: ffi.CData, n_threads: int
    ) -> None:
        """
    ...
    def ggml_graph_import(
        fname: ffi.CData, ctx_data: ffi.CData, ctx_eval: ffi.CData
    ) -> ffi.CData:
    ...
    def ggml_map_custom1_inplace_f32(
        ctx: ffi.CData, a: ffi.CData, fun: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_metal_graph_find_concurrency(
        ctx: ffi.CData, gf: ffi.CData, check_mem: bool
    ) -> None:
        """
    ...
    def ggml_mpi_graph_compute_post(
        ctx_mpi: ffi.CData, gf: ffi.CData, n_layers: int
    ) -> None:
        """
    ...
    def ggml_mpi_graph_compute_pre(
        ctx_mpi: ffi.CData, gf: ffi.CData, n_layers: int
    ) -> None:
        """
    ...
    def ggml_new_tensor(
        ctx: ffi.CData, type: int, n_dims: int, ne: ffi.CData
    ) -> ffi.CData:
        """
    ...
    def ggml_new_tensor_3d(
        ctx: ffi.CData, type: int, ne0: int, ne1: int, ne2: int
    ) -> ffi.CData:
        """
    ...
    def ggml_opt_init(
        ctx: ffi.CData, opt: ffi.CData, params: ffi.CData, nx: int
    ) -> None:
        """
    ...
    def ggml_pool_1d(
        ctx: ffi.CData, a: ffi.CData, op: int, k0: int, s0: int, p0: int
    ) -> ffi.CData:
        """
    ...
    def ggml_quantize_q2_K(
        src: ffi.CData, dst: ffi.CData, n: int, k: int, hist: ffi.CData
    ) -> int:
        """
    ...
    def ggml_reshape_3d(
        ctx: ffi.CData, a: ffi.CData, ne0: int, ne1: int, ne2: int
    ) -> ffi.CData:
        """
        return view(a)
        TODO: when we start computing gradient, make a copy instead of view
    ...
    def ggml_set_1d(
        ctx: ffi.CData, a: ffi.CData, b: ffi.CData, offset: int
    ) -> ffi.CData:
        """
    ...
    def ggml_vec_dot_q2_K_q8_K(
        n: int, s: ffi.CData, vx: ffi.CData, vy: ffi.CData
    ) -> None:
        """
        Dot product
    ...
    def ggml_vec_dot_q3_K_q8_K(
        n: int, s: ffi.CData, vx: ffi.CData, vy: ffi.CData
    ) -> None:
        """void ggml_vec_dot_q3_K_q8_K(int n, float * restrict s, const void * restrict vx, const void * restrict vy);"""
        ...

    def ggml_vec_dot_q4_K_q8_K(
        n: int, s: ffi.CData, vx: ffi.CData, vy: ffi.CData
    ) -> None:
        """void ggml_vec_dot_q4_K_q8_K(int n, float * restrict s, const void * restrict vx, const void * restrict vy);"""
        ...

    def ggml_vec_dot_q5_K_q8_K(
        n: int, s: ffi.CData, vx: ffi.CData, vy: ffi.CData
    ) -> None:
        """void ggml_vec_dot_q5_K_q8_K(int n, float * restrict s, const void * restrict vx, const void * restrict vy);"""
        ...

    def ggml_vec_dot_q6_K_q8_K(
        n: int, s: ffi.CData, vx: ffi.CData, vy: ffi.CData
    ) -> None:
    ...
    def ggml_win_unpart(
        ctx: ffi.CData, a: ffi.CData, w0: int, h0: int, w: int
    ) -> ffi.CData:
        """
    ...
    def gguf_set_arr_str(
        ctx: ffi.CData, key: ffi.CData, data: ffi.CData, n: int
    ) -> None:
    ...
    def gguf_set_tensor_data(
        ctx: ffi.CData, name: ffi.CData, data: ffi.CData, size: int
    ) -> None:
